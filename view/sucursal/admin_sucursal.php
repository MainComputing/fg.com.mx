...
<head>
    ...
    <title>Sucursal - Sistema Administrador de Empleados</title>
...
<body>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>Villas de Nuestra Señora</td>
                                            <td>50</td>
                                            <td class="center">Av. Siglo XXI</td>
                                            <td class="center">Aguascalientes</td>
                                            <td class="center">Aguascalientes</td>
                                            <td class="center">
                                            ...
                                            <button type="button" class="btn btn-outline btn-danger" id='button_eliminar'>Eliminar</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    $("#button_editar").click(function(){
        window.location.replace("/fg.com.mx/view/sucursal/modificar_sucursal.php");
	});
    $("#button_agregar").click(function(){
        window.location.replace("/fg.com.mx/view/sucursal/insertar_sucursal.php");
	});
    $("#button_info").click(function(){
        window.open("/fg.com.mx/view/sucursal/consultar_sucursal.php","","width=500,height=600");
	});
    $("#button_eliminar").click(function(){
        //window.open();
        window.open("/fg.com.mx/view/sucursal/eliminar_sucursal.php","","width=400,height=305","_blank","toolbar=no, scrollbars=no, resizable=no, top=700, left=700, width=700, height=700");
	});
    </script>
</body>
