    ...
    <div id="wrapper">
       ...
       <form method="POST" >
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="margin-bottom: 5px;">Modificar Empleado</h1>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-5 col-md-5">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <label>Nombre :</label>
                                        <input class="form-control" name="nombre" id="nombre" placeholder="Ej. Ags Madero" value="Ags Madero"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="calle" id="calle" placeholder="Calle: (Ej. Díaz Suárez)" value="Madero"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <input class="form-control" name="num_int" id="num_int" placeholder="Núm. Int. (10)" value="1000"/>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                        <div class="col-lg-5 col-md-5">
                                            <input class="form-control" name="num_ext" id="num_ext" placeholder="Núm. Ext. (120)" value="1"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
